...
import {retrieveConfig as mockedRetrieveConfig} from "../queries/retrieve-configs.tsx";
import { ConfigProvider, useConfig } from "./ConfigContext.tsx";

vi.mock("../queries/retrieve-configs.tsx", () => ({
