...
readonly class N8nQuestionPusher implements QuestionPusherInterface
{
     ...
     * @return string[]
     */
    public function pushTextRequest(array $chatRequest, string $sessionId, bool $transcribed = false): array
    {
        $allMessages = '';
        $answer = null;
        $error = null;
        ...
        $this->chatLogger->log('user', $allMessages, $sessionId, ChatLogStatus::SUCCESS, null, $transcribed);
